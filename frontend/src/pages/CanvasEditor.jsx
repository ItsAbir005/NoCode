...
export default function CanvasEditor() {
  ...
  const handleAILayoutGenerated = (layout) => {
    ...
    alert('✨ Layout generated by AI!');
  };

  const handleAILayoutImproved = (layout) => {
    setNodes(layout.nodes || []);
    setEdges(layout.edges || []);
    alert('✨ Layout improved by AI!');
  };
        ...
        <div className="px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Drag components or use AI to generate</p>
            </div>
          </div>
          ...
          {showAI && (
            <div className="absolute top-4 left-4 z-10 w-96">
              <AIChat
                ...
                onLayoutImproved={handleAILayoutImproved}
              />
            </div>
          )}
          ...
          >
            ...
            <Panel position="top-center" className="bg-white px-4 py-2 rounded-lg shadow-md">
              <div className="text-sm font-semibold text-gray-700">
                ...
                {showAI && <span className="ml-2 text-purple-600">| AI: Active ✨</span>}
              </div>
            </Panel>
          </ReactFlow>
        </div>
